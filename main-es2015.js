...
/* harmony import */ var ngx_lottie__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ngx-lottie */ "./node_modules/ngx-lottie/fesm2015/ngx-lottie.js");
/* harmony import */ var _swimlane_ngx_charts__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @swimlane/ngx-charts */ "./node_modules/@swimlane/ngx-charts/fesm2015/swimlane-ngx-charts.js");
...
let RecipeModalComponent = class RecipeModalComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let FoodpreferenceComponent = class FoodpreferenceComponent {
    constructor(service) {
        this.service = service;
...
FoodpreferenceComponent.ctorParameters = () => [
...
let MaleFemaleComponent = class MaleFemaleComponent {
    constructor(service) {
        this.service = service;
        this.next = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.prev = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
...
MaleFemaleComponent.ctorParameters = () => [
...
let PersonalizedMeasurementsComponent = class PersonalizedMeasurementsComponent {
    ...
    handleNext() {
        ...
        if (this.measurementform.controls.age.value !== "age" && this.measurementform.controls.heightft.value !== "heightft" && this.measurementform.controls.heightinch.value !== "heightin" && this.measurementform.controls.weight.value !== "") {
            ...
            const height = `${heightFt}ft ${heightinch}inch`;
...
PersonalizedMeasurementsComponent.ctorParameters = () => [
...
let PhysicalActiveComponent = class PhysicalActiveComponent {
    constructor(fb, service) {
        this.fb = fb;
        this.service = service;
        this.next = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"];
...
PhysicalActiveComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
...
let TrueComponent = class TrueComponent {
    constructor(fb, service, router, CheckoutService) {
        this.fb = fb;
        this.service = service;
        this.router = router;
...
let TypicalDayComponent = class TypicalDayComponent {
    constructor(fb, service) {
        this.fb = fb;
        this.service = service;
        this.next = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"];
...
TypicalDayComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    { type: src_app_custom_slide_service_service__WEBPACK_IMPORTED_MODULE_3__["CustomSlideService"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let WaterIntakeComponent = class WaterIntakeComponent {
    constructor(service) {
        this.service = service;
        this.next = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"];
        this.prev = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"];
...
WaterIntakeComponent.ctorParameters = () => [
    { type: src_app_custom_slide_service_service__WEBPACK_IMPORTED_MODULE_2__["CustomSlideService"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
...
let CustomSlideService = class CustomSlideService {
    constructor() {
        this.slideData = {
            gender: undefined,
            name: '',
...
let CheckoutComponent = class CheckoutComponent {
    ...
    proceed() {
        ...
        const contact = this.checkoutform.controls.phone.value;
        if (!this.checkoutform.valid) {
            ...
            this.checkoutService.placePersonalizedOrder(slideData).subscribe((order) => {
                console.log(':: order from server ', order);
                this.checkoutService.setOrderId(order.rzp_order_id);
...
let PersonalizedDietComponent = class PersonalizedDietComponent {
    constructor(service) {
        this.service = service;
    }
    ngOnInit() {
...
PersonalizedDietComponent.ctorParameters = () => [
    { type: _custom_slide_service_service__WEBPACK_IMPORTED_MODULE_2__["CustomSlideService"] }
];
...
let ProfileSummaryComponent = class ProfileSummaryComponent {
    constructor(router, service, checkoutService) {
        this.router = router;
        this.service = service;
        this.checkoutService = checkoutService;
        this.view = [330, 350];
    ...
    calcBMI() {
        let userHeightFt = parseInt(this.service.slideData.height.split('ft')[0]);
        let userHeightIn = parseInt(this.service.slideData.height.split('ft')[1].split('inch')[0].trim());
        this.userHeightM = this.convertHeight(userHeightFt, userHeightIn);
        let weightKg = this.service.slideData.weight;
        return weightKg / (this.userHeightM * this.userHeightM);
    }
    convertHeight(userHeightFt, userHeightIn) {
        let userHeightMeter = (userHeightFt * 0.305) + (userHeightIn * 0.0254);
        return userHeightMeter;
    }
    calcIdealWeight() {
        let userHeightCm = this.userHeightM * 100;
        console.log(userHeightCm, "height in cm");
        console.log(this.gender, "gender");
        if (this.gender == "male") {
            const idealBodyWeight = userHeightCm - 100;
            console.log(idealBodyWeight, "maleBodyWeight");
            return idealBodyWeight;
        }
        else if (this.gender == "female") {
            const idealBodyWeight = userHeightCm - 105;
            console.log(idealBodyWeight, "femaleBodyWeight");
            return idealBodyWeight;
        }
    }
};
ProfileSummaryComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _custom_slide_service_service__WEBPACK_IMPORTED_MODULE_3__["CustomSlideService"] },
    { type: src_app_checkout_service__WEBPACK_IMPORTED_MODULE_4__["CheckoutService"] }
];
