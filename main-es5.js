...
var CheckoutService = /** @class */ (function () {
    ...
    CheckoutService.prototype.placePersonalizedOrder = function (data) {
        var mockData = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, data, { true_statements: "sample" });
        var url = 'http://95.111.199.28/orders/create-personalized-order';
        var localUrl = 'http://localhost:3000/backend/create?model=order';
    ...
    CheckoutService.prototype.getPersonalizedDietPrice = function () {
        var url = 'http://95.111.199.28/plans/pricing';
        var localUrl = 'http://localhost:3000/backend/diet-plan-pricing';
    ...
    CheckoutService.prototype.capturePayment = function (details) {
        return this.http.post('http://localhost:3000/backend/capture-payment', details).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["throwError"])(err); }));
    };
...
var DietPlanComponent = /** @class */ (function () {
    ...
    DietPlanComponent.prototype.weekdaySelected = function (week) {
...
var MealsListComponent = /** @class */ (function () {
    ...
    MealsListComponent.prototype.openDialog = function () {
    ...
    TrueComponent.prototype.handleNext = function () {
        ...
        if (trueStatement.length >= 1) {
            ...
            this.CheckoutService.getPersonalizedDietPrice().subscribe(function (amount) {
                ...
                _this.CheckoutService.setPricing(amount);
            ...
            razorPayOptions_1.handler = (function (response) {
                ...
                _this.checkoutService.capturePayment(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, response, { amount: _this.price, rzp_order_id: rzp_order_id })).subscribe(function (res) {
                    ...
                    if (res.error_code == null) {
                        _this.windowService.window.location.href = "/payment-success";
                    }
                    else {
